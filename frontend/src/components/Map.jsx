...
import { Plane, Users, Calendar, MapPin, Palmtree, Wallet, X } from 'lucide-react';
...
export default function HotelForms({ onClose }) {
    ...
    <>
      {loading ? <TravelLoadingAnimation /> :
        <motion.div
          ...
          className="fixed top-0 left-0 w-full h-full z-50 backdrop-blur-md bg-black/40 flex items-center justify-center overflow-auto"
        >
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="relative w-full max-w-4xl bg-gray-800 rounded-2xl shadow-xl p-8 mx-4 my-10"
          >
            {/* Close Button */}
            <button
              onClick={onClose}
